...
<script>
  ...
  $(document).ready(function() {
    ...
    $("body").on("keyup", ".total_diskon", function() {
      ...
      // downpayment
      $("body").on("keyup", ".total_downpayment", function() {
      var downpayment = $(this).val();

      if(downpayment.length != 0 && downpayment != ""){

        var total = $(".total_pembelian").attr("id");
        var sisatotal = $(".total_pembelian").attr("id");

        var hasil_downpayment = sub_total-hasil_diskon*downpayment/100;
        var hasil2 = sub_total-hasil_downpayment;
        $(".total_pembelian").text("Rp."+formatNumber(hasil2)+",-");
        $(".total_form").val(hasil2);
