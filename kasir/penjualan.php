                ...
                <tbody>
                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
					  ...
					  <td class="text-center"><?php echo $d['invoice_alamat']; ?></td>
					  <td class="text-center"><?php echo $d['invoice_tlp']; ?></td>
					  <td class="text-center"><?php echo date('d-m-Y', strtotime($d['invoice_tanggalkirim'])); ?></td>
					  ...
					  <td class="text-center"><?php echo $d['invoice_downpayment']; ?>%</td>
					  <td class="text-center"><?php echo "Rp.".number_format($d['invoice_sisatotal']).",-"; ?></td>
                      <td>    
                              ...
                              <div class="modal-body">
							    ...
							    <div class="col-lg-4">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <br>
                                    <?php echo date('d-m-Y', strtotime($d['invoice_tanggalkirim'])); ?>
                                  </div>
                                ...
                                <div class="col-lg-6">
                                  <table class="table table-bordered table-striped">
									...
									<tr>
                                      <th>Downpayment</th>
                                      <td>
                                        <?php echo $d['invoice_downpayment'] ?>%
                                      </td>
                                    </tr>
									<tr>
                                      <th>Sisa Total</th>
                                      <td>
                                        <span class="total_pembelian"><?php echo "Rp.".number_format($d['invoice_sisatotal']).",-"; ?></span>
                                      </td>
                                    </tr>
                                  </table>
                                </div>
